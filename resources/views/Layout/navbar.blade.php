...
<nav class="bg-white text-black fixed bottom-0 inset-x-0 p-4 z-50 md:hidden shadow-[0_-4px_6px_rgba(0,0,0,0.2)]">
  <div class="container mx-auto flex justify-center items-center space-x-6">
    <a href="/" class="{{ Request::is('/') ? 'text-[#CB0001] font-bold border-b-2 border-[#CB0001]' : 'text-[#575757] font-bold hover:text-[#CB0001] transition duration-300' }}">
    ...
    <a href="About" class="{{ Request::is('About') ? 'text-[#CB0001] font-bold border-b-2 border-[#CB0001]' : 'text-[#575757] font-bold hover:text-[#CB0001] transition duration-300' }}">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
    ...
    <a href="Portofolio" class="{{ Request::is('Portofolio') ? 'text-[#CB0001] font-bold  border-b-2 border-[#CB0001]' : 'text-[#575757] font-bold hover:text-[#CB0001] transition duration-300' }}">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
